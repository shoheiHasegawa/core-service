...
def test_local_file_mobile_vault_gateway_list_markdown_files(tmp_path):
    ...
    """
    repo = LocalFileMobileVaultGateway()
...
def test_local_file_mobile_vault_gateway_ensure_directory(tmp_path):
...
def test_local_file_mobile_vault_gateway_move_file(tmp_path):
    """[MV-FILE-01]
    ファイルの移動テスト。
    """
    repo = LocalFileMobileVaultGateway()
...
def test_local_file_mobile_vault_gateway_save_file_exists(tmp_path):
...
def test_local_file_mobile_vault_gateway_move_file_exists(tmp_path):
